...
func (m *RateReponse) Reset()         { *m = RateReponse{} }
func (m *RateReponse) String() string { return proto.CompactTextString(m) }
func (*RateReponse) ProtoMessage()    {}
func (*RateReponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_d3dc60ed002193ea, []int{1}
}

func (m *RateReponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_RateReponse.Unmarshal(m, b)
}
func (m *RateReponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_RateReponse.Marshal(b, m, deterministic)
}
func (m *RateReponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RateReponse.Merge(m, src)
}
func (m *RateReponse) XXX_Size() int {
	return xxx_messageInfo_RateReponse.Size(m)
}
func (m *RateReponse) XXX_DiscardUnknown() {
	xxx_messageInfo_RateReponse.DiscardUnknown(m)
}

var xxx_messageInfo_RateReponse proto.InternalMessageInfo

func (m *RateReponse) GetRate() float64 {
	if m != nil {
		return m.Rate
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*RateReponse)(nil), "RateReponse")
}
...
var fileDescriptor_d3dc60ed002193ea = []byte{
	...
	,
}
...
type CurrencyClient interface {
	GetRate(ctx context.Context, in *RateRequest, opts ...grpc.CallOption) (*RateReponse, error)
}
...
func (c *currencyClient) GetRate(ctx context.Context, in *RateRequest, opts ...grpc.CallOption) (*RateReponse, error) {
	out := new(RateReponse)
...
type CurrencyServer interface {
	GetRate(context.Context, *RateRequest) (*RateReponse, error)
}
...
func (*UnimplementedCurrencyServer) GetRate(ctx context.Context, req *RateRequest) (*RateReponse, error) {
